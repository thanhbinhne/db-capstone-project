...
CREATE TABLE `bookings` (
  ...
  CONSTRAINT `customer_id_fk_booking` FOREIGN KEY (`CustomerID`) REFERENCES `customer_details` (`CustomerID`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `orderitem` (
  ...
  CONSTRAINT `order_id_fk_item` FOREIGN KEY (`OrderID`) REFERENCES `orders` (`OrderID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-09-19 10:57:04
